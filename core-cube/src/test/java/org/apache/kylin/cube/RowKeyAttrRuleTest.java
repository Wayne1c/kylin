...
public class RowKeyAttrRuleTest {
    ...
    public void testBadDesc() throws IOException {
        ValidateContext vContext = new ValidateContext();
        CubeDesc desc = JsonUtil.readValue(Files.newInputStream(Paths.get(LocalFileMetadataTestCase.LOCALMETA_TEST_DATA + "/cube_desc/test_kylin_cube_with_slr_desc.json")), CubeDesc.class);
