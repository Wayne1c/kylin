...
public class NameMappingFactory {
    ...
    public static NameMapping getDefault(CubeDesc desc) {
        ...
        return noDupName ? new RemoveDotNameMapping(DirectNameMapping.INSTANCE) : new RemoveDotNameMapping(new CachedNameMapping());
    }
    ...
    private static class CachedNameMapping implements NameMapping {
        ...
        public String getDimFieldName(TblColRef dim) {
            ...
            if (name == null) {
                ...
                name = DIM_PREFIX + dim.getTableAlias() + "_" + dim.getName();
    ...
    private static class RemoveDotNameMapping implements NameMapping {
        private NameMapping nameMapping;

        public RemoveDotNameMapping(NameMapping nameMapping) {
            this.nameMapping = nameMapping;
        }

        @Override
        public String getDimFieldName(TblColRef dim) {
            return removeDotFromName(nameMapping.getDimFieldName(dim));
        }

        @Override
        public String getMeasureFieldName(MeasureDesc met) {
            return removeDotFromName(nameMapping.getMeasureFieldName(met));
        }
