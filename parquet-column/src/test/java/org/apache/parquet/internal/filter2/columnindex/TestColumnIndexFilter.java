...
public class TestColumnIndexFilter {
  ...
  private static final OffsetIndex COLUMN1_OI = new OIBuilder()
       //curOffset = preOffset + prePageSize   -->每页的开始在文件中的位置(byte)
       //curFirstRowIndex = preFirstRowIndex + preRowCount  -->每页的开始第一个值所在的行
      .addPage(1) //page1: offset=0, firstRowIndex=0
      .addPage(6) //page2: offset=1234, firstRowIndex=1
      .addPage(2) //page3: offset=2468, firstRowIndex=7
      .addPage(5)
      .addPage(7)
      .addPage(6)
      .addPage(3)
