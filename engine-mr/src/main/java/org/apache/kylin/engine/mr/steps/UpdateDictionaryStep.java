...
public class UpdateDictionaryStep extends AbstractExecutable {
    ...
    protected ExecuteResult doWork(ExecutableContext context) throws ExecuteException {
        ...
        KylinConfig kylinConfHdfs = KylinConfig.createInstanceFromUri(metadataUrl);

        Collections.sort(mergingSegments);

        Configuration conf;
        ResourceStore hbaseRS;
        ResourceStore hdfsRS;
        FileSystem fs;
        ...
        try {
            ...
            hbaseRS = ResourceStore.getStore(kylinConfHbase);
            hdfsRS = ResourceStore.getStore(kylinConfHdfs);
