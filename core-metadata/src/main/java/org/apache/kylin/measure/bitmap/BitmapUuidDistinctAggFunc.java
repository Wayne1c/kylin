...
public class BitmapUuidDistinctAggFunc implements ParamAsMeasureCount {
    ...
    public static int result(BitmapAggregator agg) {
        BitmapCounter finalState = agg.getState();
        int index = RetentionPartialResult.putBitmapCounter(finalState);
        System.out.println("BitmapInnerDistinctAggFunc :" + Thread.currentThread());
        return index;
    }
